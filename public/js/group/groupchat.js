...
$(document).ready(function(){
  ...
  const lostControl = (e) => {
    ...
    if (document.hasFocus()){
      ...
      if (countDownSec < 1) {
        $.notify("Are you paying attention? The server didn't get any response for more than 1 minute. Please focus on the game (another player might be waiting for you).", {  autoHideDelay: 105000});
